...
| 8 | [`zbus-guide.md`](zbus-guide.md) | What is an in-process message bus, and why does a two-thread firmware want one? | threads and blocking calls; `poll()` and mutexes are explained in §1–§2 | [`app_channels.h`](../shared/app_channels.h) and [`relay.h`](../gateway/src/relay.h) header comments |
